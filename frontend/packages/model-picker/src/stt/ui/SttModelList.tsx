...
function AuthorLabel({ family }: { family: FamilyKey }) {
	...
	return (
		...
		>
			{config.logoSrc ? (
				/* biome-ignore lint/performance/noImgElement: Provider icons are static local PNGs served from /public; next/image adds runtime overhead for tiny 16x16 thumbnails. */
				<img
					alt={`${author} logo`}
