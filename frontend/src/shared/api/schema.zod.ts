...
export const ModelFamilySchema = z.enum(["whisper", "lite-whisper", "nemo", "gigaam", "kaldi", "t-one", "moonshine", "cohere", "sense_voice", "dolphin", "custom"]);
export type ModelFamily = z.infer<typeof ModelFamilySchema>;

export const LlmProviderSchema = z.enum(["ollama", "openrouter", "apple-intelligence"]);
export type LlmProvider = z.infer<typeof LlmProviderSchema>;

export const LlmPresetKeySchema = z.enum(["neutral", "formal", "friendly", "technical", "concise", "summarize", "reorder", "restructure", "rewordForClarity"]);
...
export const OllamaPullProgressStatusSchema = z.enum(["pulling", "downloading", "verifying", "writing", "success", "error", "cancelled"]);
...
export const CloudSttErrorCodeSchema = z.enum(["auth", "network", "key_missing", "rate_limit", "provider_error"]);
...
export const FitReasonSchema = z.enum(["exceeds_vram", "exceeds_ram", "tight_vram", "tight_ram", "no_gpu_available", "requires_cpu_quant", "stt_already_uses_gpu", "stt_already_uses_ram", "unknown_footprint", "ok"]);
