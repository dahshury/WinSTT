...
describe("dialogAnimation", () => {
	test("re-exports the CSS module asset (string under bun, object under bundlers)", () => {
		...
		// Next.js/Webpack this becomes the generated class-name map (an object
		// with backdrop/popup keys). Both shapes are valid here — assert the
		// import simply succeeds and is non-empty.
