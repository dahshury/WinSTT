...
} from "../lib/model-filters-menu-components";
import {
...
const TRIGGER_CLASS_BASE =
  "inline-flex size-7 shrink-0 cursor-pointer items-center justify-center rounded-md border-0 bg-transparent p-0 text-foreground-secondary outline-none hover:bg-foreground/[0.06] focus-visible:ring-2 focus-visible:ring-accent";
