...
describe("SttModelSelector streaming filter", () => {
  ...
  test("merges legacy 80ms and 480ms NeMo precision row ids", () => {
    ...
    expect(screen.getAllByText("Streaming NeMo FastConformer CTC")).toHaveLength(1);
    expect(screen.getAllByText("Streaming NeMo FastConformer RNN-T")).toHaveLength(1);
