...
<ModelTable
  ...
  caption="Every log that can land in the bundle, and how each one rotates."
/>
...
<ModelTable
  ...
  caption="Application-log scopes — filter on these to narrow a search."
/>
...
<ModelTable
  ...
  caption="Engine-compatibility scopes, present only when the legacy engine log exists."
/>
