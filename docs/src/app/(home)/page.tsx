...
const features = [
	{
		...
		description: "See words appear as you speak. Dual-model architecture runs a fast model for live preview alongside a large model for final accuracy.",
	...
	},
	{
		...
		title: "30+ AI Models",
		description: "OpenAI Whisper, NVIDIA NeMo, GigaAM, Kaldi, and more. Switch models with a single setting change.",
		href: "/docs/models",
	},
	{
		icon: (
	...
	},
	{
		...
		description: "Drop audio files for batch transcription. Export as plain text or SRT subtitles with timestamps.",
		...
		<div className="flex flex-col items-center flex-1 overflow-hidden">
			...
			<section className="relative w-full flex flex-col items-center pt-24 pb-12 px-6">
				...
				<div
					...
					style={{ background: "radial-gradient(ellipse, hsla(43, 96%, 56%, 0.06) 0%, transparent 70%)" }}
				/>
				...
				<div className="relative mb-8">
					<div
						...
						style={{ background: "hsla(43, 96%, 56%, 0.08)", animationDuration: "3s" }}
					/>
					<div
				...
				<p className="text-lg max-w-xl text-center leading-relaxed" style={{ color: "hsla(0, 0%, 100%, 0.5)" }}>
					Local speech-to-text for Windows. Real-time transcription powered by Whisper, NeMo, and 30+ AI models — completely offline, entirely on your hardware.
				</p>
			...
			<section className="relative w-full flex flex-col items-center px-6 pt-4 pb-20">
				...
				<div
					...
					style={{ background: "radial-gradient(ellipse, hsla(43, 96%, 56%, 0.04) 0%, transparent 70%)" }}
				/>
			...
			<section className="w-full max-w-3xl px-6 pb-16">
				<div
					...
					style={{
						background: "linear-gradient(135deg, hsla(150, 40%, 12%, 0.3) 0%, hsla(240, 10%, 8%, 0.5) 100%)",
				...
				>
					<div className="flex items-start gap-4">
						...
						<div>
							<h3 className="font-semibold text-sm mb-1.5" style={{ color: "hsla(150, 60%, 75%, 0.95)" }}>
			...
			<section className="w-full max-w-5xl px-6 pb-24">
				<div className="text-center mb-10">
					<h2 className="text-2xl font-bold tracking-tight mb-2" style={{ color: "hsla(0, 0%, 100%, 0.9)" }}>
						Everything you need
					</h2>
					<p className="text-sm" style={{ color: "hsla(0, 0%, 100%, 0.35)" }}>
						A complete speech-to-text toolkit, running locally on your Windows machine
					</p>
				</div>
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
					{features.map((feature) => (
						...
						>
							...
							<h3 className="font-semibold text-[13.5px] mb-1.5 transition-colors duration-200" style={{ color: "hsla(0, 0%, 100%, 0.9)" }}>
								{feature.title}
							</h3>
							<p className="text-[13px] leading-relaxed" style={{ color: "hsla(0, 0%, 100%, 0.4)" }}>
								{feature.description}
							</p>
							{/* Arrow hint on hover */}
							<div
