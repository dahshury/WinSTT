    ...
    <section className="relative flex w-full flex-col items-center px-6 pt-5 pb-12">
      ...
      <a
        ...
        style={{
          ...
          border:
            "1px solid color-mix(in oklab, var(--brand-accent) 28%, transparent)",
      ...
      <div
        ...
        style={{
          background:
            "color-mix(in oklab, var(--brand-success) 8%, transparent)",
          border:
            "1px solid color-mix(in oklab, var(--brand-success) 18%, transparent)",
        }}
      ...
      >
        {privacyBadges.map((badge, index) => (
          <div
            ...
            style={{
              color:
                "color-mix(in oklab, var(--brand-success) 90%, transparent)",
              fontSize: "12px",
              fontWeight: 500,
              borderColor:
                "color-mix(in oklab, var(--brand-success) 18%, transparent)",
            }}
          >
            {badge.icon}
            {badge.label}
      ...
      <nav
        ...
        className="home-actions mt-8 inline-flex flex-col items-stretch rounded-lg sm:flex-row"
        style={{
          gap: "1px",
          background: "color-mix(in oklab, var(--fg-strong) 12%, transparent)",
          border:
            "1px solid color-mix(in oklab, var(--fg-strong) 12%, transparent)",
        }}
      >
        <LatestDownloadMenu variant="hero" />
        <Link
          to="/docs/$"
          params={{ _splat: "" }}
          className="home-action-link inline-flex items-center justify-center gap-2 px-5 py-2.5 font-medium text-sm transition-all hover:brightness-150"
          style={{
