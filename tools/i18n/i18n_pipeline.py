...
Run from repo root:  python tools/i18n/i18n_pipeline.py extract
                     python tools/i18n/i18n_pipeline.py merge
"""
import json
import os
import sys
...
# Keep in sync with tools/i18n/check-i18n.ts IDENTICAL_BY_DESIGN.
IDENTICAL_BY_DESIGN = {
    "titleBar.appName",
    "about.appInfoTitle",
    "about.appVersion",
