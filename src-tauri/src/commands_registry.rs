...
pub fn make_specta_builder() -> tauri_specta::Builder<tauri::Wry> {
    let builder = Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        commands::cleanup::app_data_usage,
        commands::cleanup::remove_app_data_category,
        ...
        winstt::commands::settings::winstt_get_settings_snapshot,
        winstt::commands::settings::winstt_patch_settings,
        winstt::commands::settings::settings_reset_defaults,
        ...
        winstt::commands::tts_voice::tts_prepare_reference_clip,
        winstt::commands::tts_voice::tts_build_reference,
        winstt::commands::tts_voice::tts_delete_reference_clips,
        winstt::commands::tts_voice::tts_read_voice_library,
        winstt::commands::tts_voice::tts_write_voice_library,
        winstt::commands::tts_voice::generate_voice_design_prompt,
        winstt::commands::tts_voice::insert_paralinguistic_tags,
        ...
        winstt::commands::mode_transition::recording_mode_transition_state,
        ...
        winstt::commands::swap_events::stt_switch_model,
        ...
        winstt::commands::encoder_dict::encoder_dict_status,
        winstt::commands::encoder_dict::encoder_dict_download_start,
        winstt::commands::encoder_dict::encoder_dict_download_pause,
        winstt::commands::encoder_dict::encoder_dict_download_resume,
        winstt::commands::encoder_dict::encoder_dict_download_cancel,
        winstt::commands::encoder_dict::encoder_dict_remove,
        winstt::commands::encoder_dict::encoder_dict_preload,
        winstt::commands::encoder_dict::encoder_dict_unload,
        ...
        winstt::commands::context::context_list_windows,
        ...
        winstt::commands::history::history_search,
        ...
        winstt::commands::diag::diag_set_log_streaming,
        ...
        winstt::commands::context_playground::context_playground_capture_hwnd,
        ...
        winstt::commands::permission::permission_run_preflight,
        winstt::commands::permission::permission_request_microphone,
        winstt::commands::permission::permission_request_accessibility,
        ...
        winstt::commands::cancel::stt_skip_post_processing,
        winstt::commands::custom_models::open_custom_models_folder,
        winstt::commands::download::winstt_cancel_download,
        winstt::commands::model_lifecycle::stt_model_lifecycle_snapshots,
