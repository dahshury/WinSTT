        ...
        try:
            ...
            while not self._transcription_queue_service.is_empty():
                try:
                    ...
                    # Calculate progress
progress_percentage = (
    self._progress_tracking_service.get_batch_progress_percentage()
...
audio_data = (
    eval(queue_item.file_path)  # Note: In real implementation, use proper serialization)
    ...
    def _process_audio_file(
        ...
        try:
            ...
            if success:
                ...
                success_message = f"Saved transcript to: {os.path.basename(output_path,
    )}.{extension}{file_count_text}"
    ...
    def _transcribe_audio_data(
        ...
        try:
            ...
            if success:
                extension = request.configuration.output_format.value
                success_message
                 =  f"Saved transcript to: {os.path.basename(output_base_path,
    )}.{extension}{file_count_text}"
