        ...
        try:
            ...
            for i, file_path in enumerate(valid_files):
                try:
                    ...
                    # Update progress
progress = (
    self._progress_tracking_service.get_progress_percentage(i, len(valid_files)))
...
success = (
    self._transcription_queue_service.add_video_to_queue(file_path))
                            ...
                            if success:
                                ...
                                file_statuses.append(FileProcessingStatus(
                                    ...
                                    progress=100.0,
queue_position = (
    self._transcription_queue_service.get_queue_size()),
                                ))
