...
from src_refactored.domain.window_state_management import (
    ManagePhase,
    ManageResult,
    StateTransition,
    WindowState,
...
class GeometryManagementServiceProtocol(Protocol):
    ...
    window: Any, mode: GeometryMode, reference_geometry: WindowGeometry | None = None) -> WindowGeometry:
        ...
        try:
            ...
            try:
                ...
                if request.transition_config.geometry_mode != GeometryMode.PRESERVE:
                    if request.transition_config.geometry_mode ==  GeometryMode.CUSTOM_POSITION and request.transition_config.custom_geometry:
                        # Use custom geometry
            ...
            if request.persistence_config and request.persistence_config.persistence_mode != PersistenceMode.NONE:
                try:
