...
from ....domain.transcription.entities import ModelConfiguration, TranscriptionSession
from ....domain.transcription.value_objects import AudioData, TranscriptionState
...
class StartTranscriptionUseCase(UseCase[StartTranscriptionRequest, StartTranscriptionResponse]):
    ...
    def execute(self, request: StartTranscriptionRequest,
        ...
        Returns:
            Result containing the start transcription response
        """
        try:
...
config_result = (
    self._transcription_session.configure_model(request.model_configuration))
