...
from src_refactored.domain.transcription.entities import ModelConfiguration, TranscriptionSession
        ...
        try:
            ...
            if self._transcription_session.get_state() == TranscriptionState.PROCESSING:
                return Result.failure(
                    ...
                    "Model configuration blocked by active transcription",
                )
