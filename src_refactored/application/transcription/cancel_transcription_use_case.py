...
class CancelTranscriptionUseCase(UseCase[CancelTranscriptionRequest, CancelTranscriptionResponse]):
    ...
    def _check_partial_result_availability(self, transcription_result) -> bool:
        ...
        return bool(
            transcription_result.state == TranscriptionState.PROCESSING 
            and hasattr(transcription_result, "progress_percentage")
            and transcription_result.progress_percentage 
            and transcription_result.progress_percentage > 10,
        )
