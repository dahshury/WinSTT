...
from ..queries.get_widget_state_query import GetWidgetStateQuery, WidgetStateResult
        ...
        try:
            ...
            if not current_state_result.is_success:
                self._logger.log_error(
                    ...
                    widget_id=query.widget_id,
                    error=current_state_result.error,
                )
                return Result.failure(current_state_result.error)
