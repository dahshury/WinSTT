...
class StartupApplicationResponse:
    ...
    application: Any | None = None  # QApplication instance
    main_window: Any | None = None  # Main window instance
    logger: logging.Logger | None = None
    completed_phases: list[StartupPhase] = None
...
class StartupApplicationUseCase:
    ...
    def _initialize_framework(self, request: StartupApplicationRequest, response: StartupApplicationResponse,
        ...
        try:
            args = request.command_line_args or sys.argv
