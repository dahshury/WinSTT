...
from src_refactored.domain.application_lifecycle.entities import StartupConfiguration
from src_refactored.domain.application_lifecycle.entities.application_instance import (
    ApplicationInstance,
)
from src_refactored.domain.application_lifecycle.value_objects import StartupPhase, StartupResult
from src_refactored.domain.common.ports.command_line_port import ICommandLinePort
from src_refactored.domain.main_window.entities.main_window_instance import MainWindowInstance
