...
from ....domain.audio.value_objects.status_metrics import RecordingMetrics
...
class GetRecordingStatusUseCase(UseCase[GetRecordingStatusRequest, GetRecordingStatusResponse]):
    ...
    def execute(self, request: GetRecordingStatusRequest,
    ) -> Result[GetRecordingStatusResponse]:
        ...
        Returns:
            Result containing the recording status response
        """
        try:
    ...
    def _get_recording_metrics(self) -> RecordingMetrics:
        ...
        try:
            ...
            elif start_time and self._audio_recorder.get_state(,
