...
from src_refactored.domain.worker_management.value_objects.communication_channel import (
    CommunicationChannel,
)
from src_refactored.domain.worker_management.value_objects.message import Message
