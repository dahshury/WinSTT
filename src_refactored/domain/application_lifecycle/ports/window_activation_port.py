...
from src_refactored.domain.application_lifecycle.entities.activation_configuration import (
    ActivationConfiguration,
)
from src_refactored.domain.application_lifecycle.entities.window_info import WindowInfo
