...
class AnimationState(ValueObject):
    ...
    @classmethod
    def fade_in(cls, duration_ms: int = 500, delay_ms: int = 0,
    ) -> "AnimationState":
    ...
    @classmethod
    def fade_out(cls, duration_ms: int = 500, delay_ms: int = 0,
    ) -> "AnimationState":
    ...
    @classmethod
    def dim(cls, opacity: float = 0.4, duration_ms: int = 500,
    ) -> "AnimationState":
        """Create a dimming animation."""
        return cls(
    ...
    @classmethod
    def restore(cls, from_opacity: float = 0.4, duration_ms: int = 500,
    ) -> "AnimationState":
        """Create a restore animation from dimmed state."""
        return cls(
