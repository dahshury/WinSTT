...
from src.application.interfaces.main_window_service import IMainWindowService
from src.domain.application_lifecycle.entities.shutdown_configuration import (
    ShutdownConfiguration,
)
from src.domain.application_lifecycle.entities.single_instance_configuration import (
    SingleInstanceConfiguration,
)
from src.domain.application_lifecycle.entities.startup_configuration import (
    StartupConfiguration,
)
from src.domain.application_lifecycle.ports.application_lifecycle_port import (
    ApplicationLifecyclePort,
)
from src.domain.application_lifecycle.ports.single_instance_port import (
    SingleInstancePort,
)
from src.domain.application_lifecycle.value_objects.instance_check_result import (
    InstanceCheckResult,
)
from src.domain.application_lifecycle.value_objects.shutdown_result import ShutdownResult
from src.domain.application_lifecycle.value_objects.startup_result import StartupResult
from src.domain.common.ports.logging_port import LoggingPort
from src.domain.common.result import Result
from src.domain.ui_coordination.ports.window_management_port import (
