...
from src.domain.audio_visualization.value_objects.visualization_control import (
    ProcessorType,
    StartPhase,
    StartResult,
)
...
if TYPE_CHECKING:
    ...
    from src.domain.audio_visualization.value_objects.visualization_configuration import (
    ...
    def execute(self, request: StartVisualizationRequest,
        ...
        try:
            ...
            if self._visualization_state_service.is_visualization_active():
                ...
                if current_processor and self._audio_processor_service.is_processor_running(current_processor):
