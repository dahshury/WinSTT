...
class UpdateProgressRequest:
    ...
    configuration: ProgressUpdateConfiguration
    message: str
...
class VisualFeedbackServiceProtocol(Protocol):
    ...
    def animate_progress_change(self, widget: Any, from_value: float,
                            to_value: float, duration_ms: int = 200) -> bool:
...
class UpdateProgressUseCase:
    ...
    def execute(self, request: UpdateProgressRequest,
        ...
        try:
            ...
            validation_errors = self.progress_validation_service.validate_progress_value(request.progress_value)
