...
from src.domain.llm.value_objects.llm_prompt import LLMPrompt
...
class InitializeLLMWorkerUseCase:
    ...
    def execute(self, request: InitializeLLMWorkerRequest,
        ...
        try:
            ...
            if request.configuration.preload_model or request.strategy == LLMWorkerStrategy.PRELOAD_MODEL:
            ...
            response.initialization_time_ms = int((datetime.utcnow() - start_time).total_seconds() * 1000)
