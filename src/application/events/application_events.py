...
from src.application.external_services.commands.call_external_service_command import (
    ServiceType,
)
from src.domain.common.events import DomainEvent
from src.domain.ui_text import UpdatePhase, UpdateResult
from src.domain.ui_widget_operations import HandlePhase, HandleResult, WidgetType
