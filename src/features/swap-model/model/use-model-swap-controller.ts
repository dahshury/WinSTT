...
function realtimePatchForMainSwap(
...
function shouldReloadForHotSwap(
  quantizationChanging: boolean,
...
function resolveCurrentRealtimeModel(
  settings: ModelSettings | undefined,
): string {
