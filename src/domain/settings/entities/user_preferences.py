...
from src.domain.settings.value_objects.audio_configuration import AudioConfiguration
from src.domain.settings.value_objects.file_path import AudioFilePath
...
from src.domain.settings.value_objects.model_configuration import (
    ModelConfiguration,
    ModelType,
    Quantization,
)
...
class UserPreferences(AggregateRoot):
    ...
    def update_recording_key(self, new_key: KeyCombination,
        ...
        # Add domain event
        from src.domain.common.events import RecordingKeyChanged
    ...
    def update_model_configuration(self, new_config: ModelConfiguration,
        ...
        # Add domain event
        from src.domain.common.events import ModelConfigurationChanged
    ...
    def update_llm_configuration(self, new_config: LLMConfiguration,
        ...
        # Add domain event
        from src.domain.common.events import LLMConfigurationChanged
    ...
    def update_audio_configuration(self, new_config: AudioConfiguration,
        ...
        # Add domain event
        from src.domain.common.events import AudioConfigurationChanged
    ...
    def toggle_output_srt(self) -> None:
        ...
        # Add domain event
        from src.domain.common.events import OutputSRTToggled
    ...
    def enable_llm_processing(self) -> None:
        ...
        if not self.llm_config.enabled:
            ...
            # Add domain event
            from src.domain.common.events import LLMProcessingEnabled
    ...
    def disable_llm_processing(self) -> None:
        ...
        if self.llm_config.enabled:
            ...
            # Add domain event
            from src.domain.common.events import LLMProcessingDisabled
