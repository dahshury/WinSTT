...
from src.domain.audio_visualization.value_objects import (
    AudioBuffer,
    WaveformData,
)
...
class AudioProcessor(Entity):
    ...
    def __post_init__(self) -> None:
        ...
        # Ensure base Entity lifecycle fields are initialized before using __post_init__
        # Generate a temporary domain ID; infrastructure may overwrite it later
        Entity.__init__(self, DomainIdentityGenerator.generate_domain_id("audio_proc"))
        super().__post_init__()
