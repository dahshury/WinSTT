...
export function CreatableCombobox({
	...
	const exactExists = items.some((i) => i.label.trim().toLowerCase() === needle);
	...
	const rows: Row[] = [
		...
		...(canCreate ? [{ id: CREATE_ID, label: trimmed, deletable: false, isCreate: true }] : []),
	];
		...
		<div className={className ?? "w-full"}>
			...
			>
				<div className="relative flex w-full items-center">
					<Combobox.Input
						className={`h-8 w-full rounded-sm ${surfaceClasses(inputLevel)} ps-2.5 pe-7 font-inherit text-body text-foreground leading-normal outline-none placeholder:text-foreground-muted focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1 focus-visible:ring-offset-surface-1`}
