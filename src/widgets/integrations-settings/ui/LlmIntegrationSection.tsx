...
/**
 * Language-model integration: the local Ollama endpoint plus the CLOUD
 * OpenRouter key. NOTE: the OpenRouter key is dual-purpose — besides the LLM
 * provider it ALSO unlocks OpenRouter cloud *transcription* models in the Model
 * tab's Cloud source (it shares the single key). The STT-only providers
 * (ElevenLabs) live in the sibling section.
 */
