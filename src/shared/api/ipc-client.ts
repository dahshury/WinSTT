...
export const cancelModelDownloadQuant = (
  modelId: string,
  quantization: string,
) =>
  invokeOrDefault<void>(IPC.STT_DOWNLOAD_CANCEL_QUANT, undefined, {
    modelId,
    quantization,
  });
...
export const updaterCheckNow = () =>
  invokeOrDefault<UpdaterCheckNowResult>(IPC.UPDATER_CHECK_NOW, {
    triggered: false,
  });
