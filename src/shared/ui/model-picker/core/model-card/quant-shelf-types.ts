...
export interface QuantShelfEntry {
	...
	canResumeDownload?: boolean;
	/** Greyed / non-interactive badge (e.g. a precision the Suggested filter
	 *  judged too big for this machine's memory budgets). The label button
	 *  ignores clicks; trailing controls (delete a cached copy) stay live. */
	disabled?: boolean;
	/** Tooltip shown INSTEAD of the standard precision tooltip while
	 *  {@link QuantShelfEntry.disabled} is set (e.g. "Needs more memory than
