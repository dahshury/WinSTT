...
from src.domain.worker_management.value_objects.worker_imports import (
    WorkerImportConfig,
    WorkerImportType,
)
...
class WorkerImportsConfiguration:
    ...
    def _setup_default_configurations(self) -> None:
        ...
        self.register_worker_config(WorkerImportConfig(
            ...
            module_path="src.infrastructure.llm.llm_pyqt_worker_service",
            class_name="LLMPyQtWorkerService",
            dependencies=["src.infrastructure.llm.gemma_inference_service"],
        ))

        # Listener Worker Configuration
        self.register_worker_config(WorkerImportConfig(
            worker_type=WorkerImportType.LISTENER,
            module_path="src.infrastructure.audio.listener_worker_service",
            class_name="ListenerWorkerService",
            dependencies=["src.application.listener.audio_to_text_service.AudioToTextService"],
        ))

        # PyQt Audio Adapter Configuration
        self.register_worker_config(WorkerImportConfig(
            worker_type=WorkerImportType.PYQT_AUDIO,
            module_path="src.infrastructure.audio.pyqt_audio_adapter",
