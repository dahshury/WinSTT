...
from src.infrastructure.settings.json_settings_repository import JSONSettingsRepository
from src.presentation.qt.services.drag_drop_integration_service import (
    DragDropIntegrationService,
)
from src.presentation.qt.services.event_filter_service import EventFilterService
from src.presentation.qt.services.event_system_service import UIEventSystem
from src.presentation.qt.services.geometry_management_service import (
    GeometryManagementService,
)
from src.presentation.qt.services.opacity_effects_service import OpacityEffectsService
...
from src.presentation.qt.services.visualization_integration_service import (
...
from src.presentation.qt.services.worker_thread_management_service import (
...
class MainWindow(QMainWindow):
    ...
    def _apply_configuration(self) -> None:
        ...
        self.start_sound = cfg.get("sound_path", "@resources/splash.wav")
    ...
    def _get_default_configuration(self) -> dict:
        ...
        return {
            "enable_sound": True,
            "sound_path": "@resources/splash.wav",
            "output_srt": False,
            "rec_key": "CTRL+ALT+A",
            "model": "whisper-turbo",
            "quantization": "Full",
