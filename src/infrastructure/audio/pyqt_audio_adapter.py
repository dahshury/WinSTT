...
from src.application.listener.audio_to_text_service import AudioToTextService

if TYPE_CHECKING:
    from collections.abc import Callable

    from src.infrastructure.audio.consolidated_listener_service import ConsolidatedListenerService
