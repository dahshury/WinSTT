...
from src.domain.common.value_objects.result import Result
from src.domain.ui_widgets.ports.button_port import IButton
from src.domain.ui_widgets.ports.label_port import ILabel
from src.domain.ui_widgets.ports.line_edit_port import ILineEdit
