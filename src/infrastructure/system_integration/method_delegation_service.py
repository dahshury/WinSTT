...
from src.domain.system_integration.value_objects.method_delegation import (
...
class MethodDelegationService(QObject):
    ...
    def create_for_main_window(cls) -> "MethodDelegationService":
        ...
        # Prefer controller-based wiring in the refactored presentation layer.
        # Leave empty delegation list to avoid importing legacy window methods.
        config = DelegationConfiguration(
            target_class_name="MainWindow",
            source_module_path="src.presentation.main_window.window_methods",
            methods=[],
            auto_import=False,
