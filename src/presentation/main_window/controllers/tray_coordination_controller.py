...
from src.domain.system_integration.entities.system_tray_integration import (
    SystemTrayIntegration,
    TrayActionType,
    TrayConfiguration,
)
from src.domain.system_integration.ports.system_tray_port import ISystemTrayPort
    ...
    def show_tray_notification(self, title: str, message: str) -> None:
        ...
        if self._tray_integration and self._tray_id:
            try:
                ...
                from src.domain.system_integration.ports.system_tray_port import (
                    TrayMessageType,
                )
