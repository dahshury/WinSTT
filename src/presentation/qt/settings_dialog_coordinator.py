...
from src.infrastructure.presentation.qt.ui_core_abstractions import (
    IUIEventHandler,
)
from src.presentation.core.abstractions import (
    IUIComponent,
    Result,
)
from src.presentation.core.container import injectable

if TYPE_CHECKING:
    from PyQt6.QtWidgets import QWidget

    from src.infrastructure.presentation.qt.ui_core_abstractions import UIEvent
